...
import org.zywx.wbpalmstar.plugin.ueximagebrowser.ViewPager.OnPageChangeListener;
...
public class PictureActivity extends Activity implements OnClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		viewPager.notifyOrientationChanged(config.orientation);
		viewPager.setAdapter(pagerAdapter);
		viewPager.setOnPageChangeListener(this);
		viewPager.setCurrentItem(showIndex);
		viewPager.notifyPageSelected();
	}
	...
	private void backForResult() {
		int index = viewPager.getCurrentPageIndex();
	...
	public void onPageSelected(int lastIndex, int position) {
		...
		currentImageView.setOnSingleTapListener(new OnSingleTapListener() {
			@Override
	...
	public void onConfigurationChanged(Configuration newConfig) {
		...
		viewPager.notifyOrientationChanged(newConfig.orientation);
	}
}